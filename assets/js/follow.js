$(function(){
  $('.follow-btn').click(function(){
    ...
    if ($button.hasClass('following-btn')) {
      $.post('http://localhost:8888/tweetAcademy/core/ajax/follow.php', {unfollow:followID, profile:profile}, function(data){
      ...
      $.post('http://localhost:8888/tweetAcademy/core/ajax/follow.php', {follow:followID, profile:profile}, function(data){
        data = JSON.parse(data);
